import {
  ButtonBase_default
} from "./chunk-22DDL2A2.js";
import "./chunk-WJ66L2LS.js";
import "./chunk-XSJAMWMO.js";
import {
  Paper_default
} from "./chunk-R3C7KYD4.js";
import {
  capitalize_default
} from "./chunk-6JTWD4VC.js";
import {
  _extends,
  ...
  styled_default,
  useThemeProps
} from "./chunk-B3FTG3DD.js";
import {
  require_prop_types
} from "./chunk-YGKIC37A.js";
import "./chunk-4OEZZG3F.js";
import {
  __toESM,
  require_react
...
function createSvgIcon(path, displayName) {
  const Component = (props, ref) => (0, import_jsx_runtime4.jsx)(SvgIcon_default, _extends({
...
var _CloseIcon;
var _excluded3 = ["action", "children", "className", "closeText", "color", "icon", "iconMapping", "onClose", "role", "severity", "variant"];
...
var Alert = React9.forwardRef(function Alert2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsxs)(AlertRoot, _extends({
    role,
    elevation: 0,
    ownerState,
    className: clsx_m_default(classes.root, className),
    ...
    children: [icon !== false ? (0, import_jsx_runtime10.jsx)(AlertIcon, {
      ...
      children: (0, import_jsx_runtime10.jsx)(IconButton_default, {
        ...
        color: "inherit",
        onClick: onClose,
        children: _CloseIcon || (_CloseIcon = (0, import_jsx_runtime10.jsx)(Close_default, {
          fontSize: "small"
        }))
      })
    }) : null]
