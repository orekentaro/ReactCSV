...
var Snackbar = React3.forwardRef(function Snackbar2(inProps, ref) {
  ...
  const timerAutoHide = React3.useRef();
  ...
  return (0, import_jsx_runtime4.jsx)(ClickAwayListener_default, _extends({
    onClickAway: handleClickAway
  }, ClickAwayListenerProps, {
    children: (0, import_jsx_runtime4.jsx)(SnackbarRoot, _extends({
      className: clsx_m_default(classes.root, className),
      onBlur: handleBlur,
      onFocus: handleFocus,
...
// dep:@mui_material_Snackbar
var mui_material_Snackbar_default = Snackbar_default;
export {
  mui_material_Snackbar_default as default,
